...
#   - the tracking script (t.js)
#   - the built dashboard SPA
#
# A single private S3 bucket fronted by CloudFront via Origin Access Control.
...
resource "aws_cloudfront_distribution" "assets" {
  ...
  comment             = "${local.name} assets (tracking script + dashboard)"
  ...
  # SPA fallback: serve index.html for client-side routes (404/403 -> /).
